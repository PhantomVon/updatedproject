...
public final class FragmentHousesBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static FragmentHousesBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentHousesBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_houses, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentHousesBinding bind(@NonNull View rootView) {
